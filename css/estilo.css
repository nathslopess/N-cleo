...
.conteiner-texto-etapas h2 {
    font-size: 30px;
    margin-bottom: 10px;
}

.conteiner-texto-etapas p {
    font-size: 20px;
    line-height: 1.4;
}
...
.gallery-item.active-slide .carousel-caption-titulo {
    opacity: 1; 
}
...
@media (max-width: 1440px) {
    ...
    .texto-etapas-tamanho h2 {
        font-size: 25px;
    }

    .texto-etapas-tamanho p {
        font-size: 15px;
    }
}

/* Responsividade para página de Home */
